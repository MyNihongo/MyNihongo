...
public sealed class KanjiDatabase : DatabaseFixture
{
	...
	private static void PrepareData(DatabaseConnection connection, IConfiguration configuration)
	{
		...
		connection.KanjiUserEntries.BulkCopy(new KanjiUserEntryDatabaseRecord[]
		{
			...
			new() { UserId = 1L, KanjiId = 11, FavouriteRating = 50, Mark = 23, Notes = "some user notes" },
			...
			new() { UserId = 2L, KanjiId = 10, IsDeleted = true, FavouriteRating = 20, Mark = 33, Notes = "my favourite season" },
