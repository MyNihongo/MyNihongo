...
public abstract class DatabaseCollectionFixture : IDisposable
{
	private readonly ThrowawayDatabase _database;
	private readonly Mock<IConfiguration> _mockConfiguration = new();

	protected DatabaseCollectionFixture(Action<DatabaseConnection> prepareData)
	{
	...
	internal IConfiguration Configuration => _mockConfiguration.Object;
